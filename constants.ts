...
export const SKILL_MODES = {
  ascending_intervals: {
    ...
    skillType: "intervals",
    stages: [
      { xpRequirement: 0, skillNodeId: ["asc_2nds", "asc_3rds"] },
      { xpRequirement: 15, skillNodeId: ["asc_4ths", "asc_5ths"] },
      { xpRequirement: 30, skillNodeId: ["asc_octave"] },
      { xpRequirement: 45, skillNodeId: ["asc_6ths", "asc_7ths"] },
      { xpRequirement: 65, skillNodeId: ["asc_9ths"] },
      { xpRequirement: 80, skillNodeId: ["asc_10_11"] },
      { xpRequirement: 100, skillNodeId: ["asc_12_13"] },
    ],
  },
  ...
  descending_intervals: {
    ...
    skillType: "intervals",
    stages: [
      { xpRequirement: 0, skillNodeId: ["desc_2nds", "desc_3rds"] },
      { xpRequirement: 15, skillNodeId: ["desc_4ths", "desc_5ths"] },
      { xpRequirement: 30, skillNodeId: ["desc_octave"] },
      { xpRequirement: 45, skillNodeId: ["desc_6ths", "desc_7ths"] },
      { xpRequirement: 65, skillNodeId: ["desc_9ths"] },
      { xpRequirement: 80, skillNodeId: ["desc_10_11"] },
      { xpRequirement: 100, skillNodeId: ["desc_12_13"] },
    ],
  },
  ...
  harmonic_intervals: {
    ...
    skillType: "intervals",
    stages: [
      { xpRequirement: 0, skillNodeId: ["harmonic_2nds", "harmonic_3rds"] },
      { xpRequirement: 15, skillNodeId: ["harmonic_4ths", "harmonic_5ths"] },
      { xpRequirement: 30, skillNodeId: ["harmonic_octave"] },
      { xpRequirement: 45, skillNodeId: ["harmonic_6ths", "harmonic_7ths"] },
      { xpRequirement: 65, skillNodeId: ["harmonic_9ths"] },
      { xpRequirement: 80, skillNodeId: ["harmonic_10_11"] },
      { xpRequirement: 100, skillNodeId: ["harmonic_12_13"] },
    ],
  },
  ...
  chords: {
    ...
    skillType: "chords",
    stages: [
      { xpRequirement: 0, skillNodeId: ["chord_triads", "chord_sus_power"] },
      { xpRequirement: 25, skillNodeId: ["chord_major_minor_7"] },
      { xpRequirement: 45, skillNodeId: ["chord_dom_dim_7"] },
      { xpRequirement: 65, skillNodeId: ["chord_9ths"] },
      { xpRequirement: 85, skillNodeId: ["chord_11_69"] },
      { xpRequirement: 105, skillNodeId: ["chord_13ths"] },
      { xpRequirement: 130, skillNodeId: ["chord_added"] },
      { xpRequirement: 160, skillNodeId: ["chord_altered_7"] },
      { xpRequirement: 200, skillNodeId: ["chord_altered_13"] },
    ],
  },
  ...
  notes: {
    ...
    skillType: "notes",
    stages: [
      { xpRequirement: 0, skillNodeId: ["notes_white_1"] },
      { xpRequirement: 10, skillNodeId: ["notes_white_2"] },
      { xpRequirement: 25, skillNodeId: ["notes_black_1"] },
      { xpRequirement: 40, skillNodeId: ["notes_black_2"] },
    ],
  },
